...
RSpec.describe 'Posts show page', type: :feature do
  before :each do
    ...
    @post1.comments.create!(text: 'comment 1 from user 1', user_id: @user1.id, post_id: @user1.id)
    @post1.comments.create!(text: 'comment 2 from user 1', user_id: @user1.id, post_id: @user1.id)
    @post1.comments.create!(text: 'comment 3 from user 2', user_id: @user1.id, post_id: @user1.id)
    @post1.comments.create!(text: 'comment 4 from user 2', user_id: @user1.id, post_id: @user1.id)
