...
RSpec.describe 'Posts show page', type: :feature do
  before :each do
    ...
    @post1.comments.create!(user_id: @user1, text: 'comment 1 from user 1')
    @post1.comments.create!(user_id: @user1, text: 'comment 2 from user 1')
    @post1.comments.create!(user_id: @user2, text: 'comment 3 from user 2')
    @post1.comments.create!(user_id: @user2, text: 'comment 4 from user 2')
