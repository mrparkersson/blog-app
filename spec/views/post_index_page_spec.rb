...
RSpec.describe 'Login', type: :feature do
  describe 'User' do
    before(:each) do
      @user1 = User.create(name: 'Parker', password: '12345678', bio: 'I am full-stack dev',
                           email: 'parker@gmail.com', confirmed_at: Time.now)
      visit root_path
      ...
      @post1 = Post.create(title: 'To Be',
                           text: 'The problem around the world is:
      ...
      @post3 = Post.create(title: 'Hey',
                           text: 'What do you think of Halo season 1..."',
                           comments_counter: 0,
                           likes_counter: 0, user: @user1)

      @comment1 = Comment.create(text: 'This is the first comment', user: User.first,
                                 post: Post.first)
